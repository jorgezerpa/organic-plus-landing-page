...
const sectionOneCards = [
    { icon: "./assets/icons/icono_1.png", text: "En OrganicPlus somos cada vez más conscientes de lo perjudicial de los químicos y compuestos de la mayoría de los cosméticos. Es por eso que hemos decidido ofrecerte a ti y al medio ambiente productos orgánicos libres de sulfatos, parabenos y siliconas. <br> Se parte de lo natural y Organic reparara de manera natural el deterioro del cabello y consigue que vuelva a ser suave y sedoso con Organic plus." },
    ...
    { icon: "./assets/icons/icono_3.png", text: "Tamaños ideales para una duración óptima con productos elaborados con los más altos estándares de calidad, con precios irresistibles para cualquier presupuesto." },
]
